...
Mobile.setText(findTestObject('Object Repository/LOGIN_PAGE/android.widget.EditTextEmail'), GlobalVariable.RANDOM_EMAIL_REGISTER, 0)

Mobile.setText(findTestObject('Object Repository/LOGIN_PAGE/android.widget.EditTextPassword'), 'Indones1@', 0)

Mobile.tap(findTestObject('Object Repository/LOGIN_PAGE/android.view.ViewButtonMasuk'), 0)